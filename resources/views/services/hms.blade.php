...
<div class=" mt-3 d-flex justify-content-evenly">
    <a href="{{route('hms')}}"><button type="button" class="btn btn-danger">Previous</button></a>
    <a href="{{route('contactcenter')}}"><button type="button" class="btn bg-successes text-white">Next</button></a>
</div>
<!-- buttons -->
