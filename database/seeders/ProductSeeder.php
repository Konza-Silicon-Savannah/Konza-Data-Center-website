    ...
    public function run()
    {
        ...
        $products = [
            ...
            [
                ...
                'description' => 'Core i3, 8GB RAM , 1TB Storage',
                'price' => 10,
            ],
            //  [
            //     'service' => 'Virtual Desktop Infrastructure',
            ...
            [
                ...
                'description' => '500MB Memory, 33GB System Disk, 300GB Bandwidth',
                'price' => 1800,
            ],
            [
                'service' => 'Web hosting',
                'name' => 'Konza Personal Standard (Low)',
                'description' => '500MB Memory, 40GB System Disk, 400GB Bandwidth ',
                'price' => 5000,
            ], [
                'service' => 'Web hosting',
                'name' => 'Konza Personal Enterprise (Low)',
                'description' => '500GB Memory, 50GB System Disk, 500GB Bandwidth ',
                'price' => 6000,
            ], [
                'service' => 'Web hosting',
                'name' => 'Konza Personal Executive(Low) ',
                'description' => '500GB Memory, 70GB System Disk, 700GB Bandwidth ',
                'price' => 8000,
            ],
            [
                'service' => 'Web hosting',
                'name' => 'Konza Business Lite(High) ',
                'description' => '1GB Memory, 50GB System Disk, Unlimited Bandwidth  ',
                'price' => 5200,
            ],[
                'service' => 'Web hosting',
                'name' => 'Konza Business Standard (High) ',
                'description' => '1.5GB Memory, 70GB System Disk, Unlimited Bandwidth',
                'price' => 7600,
            ],[
                'service' => 'Web hosting',
                'name' => 'Konza Business Enterprise(High) ',
                'description' => '2GB Memory, 100GB System Disk, Unlimited Bandwidth ',
                'price' => 11000,
            ],[
                'service' => 'Web hosting',
                'name' => 'Konza Personal Executive(High) ',
                'description' => 'Unlimited Memory, 150GB System Disk, Unlimited Bandwidth ',
                'price' => 16000,
            ],
            // [
            //     'service' => 'Colocation',
